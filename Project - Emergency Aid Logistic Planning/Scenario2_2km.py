...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 14 14:14:12 2024
...
model.setObjective(quicksum(Z[j]*p[j] for j in v1), GRB.MAXIMIZE)
...
if model.status == GRB.OPTIMAL:
    print(f"With the radius = 2km, the optimal objective value is to cover {model.objVal} people.")
else:
